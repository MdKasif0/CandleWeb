    ...
    <main className="flex min-h-screen flex-col items-center bg-background p-4 font-sans text-foreground relative overflow-hidden">
      ...
      <div className="w-full max-w-2xl relative z-10">
        <header className="relative mb-8 flex h-14 items-center">
            <Link href="/account" className="absolute left-0 flex items-center text-muted-foreground transition-colors hover:text-white">
        ...
        <div className="px-2">
            ...
            <div className="space-y-8 text-white/80 leading-relaxed">
                ...
                <section>
                    <h2 className="text-xl font-semibold mb-3 text-white">3. Use of Information</h2>
                    <p>
                ...
                <section>
                    <h2 className="text-xl font-semibold mb-3 text-white">4. Data Storage and Security</h2>
                    <p>
