      ...
      <div className="w-full max-w-sm relative z-10">
        <div className="flex flex-col items-center text-center mb-8">
          <Link href="/welcome" className="flex items-center gap-2 mb-4">
            <VIcon />
            <span className="text-2xl font-bold text-foreground">CandleWeb</span>
          </Link>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-2 bg-muted rounded-full mb-6 p-1 h-auto border">
