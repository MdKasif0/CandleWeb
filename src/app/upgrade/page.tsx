...
const PlanCard = ({ plan }: { plan: typeof yearlyPlans[0] }) => (
    <Card className="bg-card border relative overflow-hidden shadow-lg shadow-primary/10 transition-all hover:shadow-primary/20 hover:-translate-y-1 duration-300">
        {plan.save && (
        ...
        <CardContent className="p-6">
            <Badge variant="outline" className="mb-4 uppercase border-primary/30 text-primary dark:bg-primary/20">{plan.name}</Badge>
            ...
            <ul className="space-y-3 text-sm text-card-foreground/80">
             ...
             <Button className="w-full mt-8 rounded-full py-6 text-lg font-semibold shadow-lg shadow-primary/20 transition-opacity hover:opacity-90">
                Choose Plan
            </Button>
        </CardContent>
    </Card>
        ...
        <main className="flex min-h-screen flex-col items-center bg-background p-4 font-sans text-foreground relative overflow-hidden">
            ...
            <div className="w-full max-w-4xl relative z-10">
                ...
                <Tabs defaultValue="pro" className="w-full">
                    <TabsList className="grid w-full max-w-xs mx-auto grid-cols-2 bg-muted border rounded-full mb-6 p-1 h-auto">
